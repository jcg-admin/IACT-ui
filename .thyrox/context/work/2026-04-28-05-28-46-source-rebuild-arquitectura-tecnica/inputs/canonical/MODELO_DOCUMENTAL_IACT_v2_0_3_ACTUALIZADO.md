# MODELO DOCUMENTAL IACT v2.0.3 (ACTUALIZADO)
## Proyecto IACT Dashboard Analytics

**Versión:** 2.0.3-rev1  
**Fecha:** 2026-01-03  
**Base:** Análisis de TXM_01, TXM_02, TXM_03, MTM_01, MTM_02, MTM_03
...
│   ├── index.rst
│   │
│   ├── reglas_negocio/                          # [CONGELADO] ~15-20 BR
│   │   ├── index.rst
│   │   │
│   │   │   # TIPO: RESTRICCIÓN (Deóntica - DEBE/NO DEBE)
...
| Tipo | Modalidad | ¿Genera UC? | Patrón | Prefijo |
|------|-----------|-------------|--------|---------|
| **Hecho** | Aléctica | NO | "[X] ES/TIENE [Y]" | BR_0xx |
| **Restricción** | Deóntica | Parcial | "[X] DEBE/NO DEBE [Y]" | BR_0xx |
| **Desencadenador** | Deóntica | **SÍ** | "SI [cond] ENTONCES [acción visible]" | BR_0xx |
| **Inferencia** | Aléctica | NO | "SI [cond] ENTONCES [estado interno]" | BR_0xx |
| **Cálculo** | Aléctica | NO | "[Resultado] = [fórmula]" | BR_0xx |

### 4.2 BR Identificadas del Sistema IACT
...
### 4.3 Árbol de Decisión para Clasificar BR
...
| Código | Nombre | App Django | UC Asociados |
|--------|--------|------------|--------------|
| MOD_Auth | Auth | apps.auth | UC-001 a UC-005 |
| MOD_Users | Users | apps.users | UC-006 a UC-009 |
| MOD_Access | Access | apps.access | UC-010, UC-011, UC-041-047 |
| MOD_Pipeline | Pipeline | apps.pipeline | UC-050 a UC-053 |
| MOD_Reports | Reports | apps.reports | UC-017 a UC-029 |
| MOD_Alerts | Alerts | apps.alerts | UC-036 a UC-040 |
| MOD_Audit | Audit | apps.audit | UC-060 a UC-063 |
| MOD_Logs | Logs | apps.logs | UC-070 a UC-072 |
...
|---------|-------|--------|
| BR identificadas | 18 | ✓ Listo para documentar |
...
| CNST_007 | Límites | BR_011 | Restricción |
| CNST_009 | Auditoría | BR_010 | Restricción |

---

## 8. CATÁLOGO DE PREFIJOS
...
```
Prioridad: 🔴 ALTA
Cantidad: 18 documentos
Ubicación: requisitos/reglas_negocio/

1. BR_001 a BR_018 según tabla sección 4.2
2. index.rst con clasificación por tipo
```
...
## 11. ARCHIVOS DE REFERENCIA (NO DOCUMENTACIÓN)

| Archivo | Propósito | Ubicación |
|---------|-----------|-----------|
| REFERENCIA_GLOBAL_MODULOS_IACT.md | Fuente para MOD_.rst | /outputs/ |
| ANALISIS_PROFUNDO_TAXONOMIAS_METAMODELOS.md | Análisis metodológico | /tmp/ |
| MODELO_DOCUMENTAL_IACT_v2_0_3.md | Este documento | /outputs/ |

---

*Modelo Documental IACT v2.0.3-rev1*
*Proyecto: IACT Dashboard Analytics*
*Fecha: 2026-01-03*
*Base: Análisis de 6 documentos TXM + MTM*
