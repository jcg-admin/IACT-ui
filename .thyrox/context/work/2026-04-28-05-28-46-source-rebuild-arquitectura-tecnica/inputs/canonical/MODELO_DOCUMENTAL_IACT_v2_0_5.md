...
```
ENDOFPART2
echo "Parte 2 creada: $(wc -l < /tmp/MODELO_DOCUMENTAL_IACT_v2_0_5_parte2.md) líneas"
Output

Parte 2 creada: 201 líneas

bash

cat > /tmp/MODELO_DOCUMENTAL_IACT_v2_0_5_parte3.md << 'ENDOFPART3'
---
...
| Tipo | Modalidad | ¿Genera UC? | Patrón | Cantidad v2.0.5 |
|------|-----------|-------------|--------|-----------------|
...
### 4.2 Template para Documentar BR (v2.0.5)

> **REFERENCIA:** Ver FND_02_Reglas_de_Negocio.rst y TPL_001_Plantilla_BR.rst
> para campos completos requeridos al documentar cada BR.
...
### 4.3 Catálogo Completo de BR v2.0.5
...
### 4.4 Detalle de BR Actualizadas (v2.0.4)
...
### 4.5 Árbol de Decisión para Clasificar BR
...
### 5.2 Mapeo Actores FND_03 ↔ Agrupadores RBAC v5.1.1 (v2.0.5)

> **NOTA:** FND_03 define actores como Roles (R001-R018). RBAC v5.1.1 usa
> Agrupadores (AGR-001 a AGR-010) con filosofía "Sin Pretensiones".
> Este mapeo establece la correspondencia conceptual.

| Actor FND_03 | Rol Legacy | Agrupador RBAC v5.1.1 | Funciones Incluidas |
|--------------|------------|----------------------|---------------------|
| Actor: Gestión Usuarios | R001 USERS_FULL_MANAGER | AGR-001 administrador_usuarios | USR-001 a USR-010 |
| Actor: Visor Usuarios | R002 USERS_VIEWER | AGR-002 visor_usuarios | USR-005, USR-006 |
| Actor: Reportes | R004-R007 REPORTS_* | AGR-003 analista_reportes | RPT-001 a RPT-008 |
| Actor: Dashboard | R008-R009 DASHBOARD_* | AGR-004 visor_dashboard | RPT-001, RPT-007, RPT-008 |
| Actor: Alertas | R011-R014 ALERTS_* | AGR-005 gestor_alertas | ALR-001 a ALR-006 |
| Actor: Supervisor | R003 USERS_TEAM_MANAGER | AGR-006 supervisor_equipo | USR-005/06, RPT-001/07 |
| Actor: Auditor | R017 AUDIT_VIEWER | AGR-007 auditor | AUD-001 a AUD-004 |
| Actor: Admin Seguridad | R018 SECURITY_ADMIN | AGR-008 admin_seguridad | ACC-001 a ACC-006 |
| Actor: Admin Sistema | R016 SYSTEM_ADMIN | AGR-009 admin_sistema | PIP-*, LOG-*, config |
| Actor: Operador ETL | (nuevo) | AGR-010 operador_etl | PIP-001 a PIP-004 |

**Uso en Documentación UC:**
- En sección "Actor Primario" de cada UC, usar Agrupador
- Ejemplo: `Actor Primario: AGR-001 (administrador_usuarios)`

### 5.3 Estructura de cada MOD_xxx.rst
...
### 5.4 SEC_RULES (Integrado en MOD_Access)
...
## 7. MAPEO CNST → BR (ACTUALIZADO v2.0.5)
...
ENDOFPART5
echo "Parte 5 creada: $(wc -l < /tmp/MODELO_DOCUMENTAL_IACT_v2_0_5_parte5.md) líneas"
Output

Parte 5 creada: 233 líneas
