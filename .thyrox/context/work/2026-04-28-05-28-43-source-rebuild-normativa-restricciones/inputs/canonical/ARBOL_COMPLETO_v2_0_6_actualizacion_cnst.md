## ÁRBOL COMPLETO v2.0.6 actualización CNST
...
│   │
│   ├── restricciones/                           # [DESCONGELADO] 10 CNST - v1.1.0 - 10,071 líneas
│   │   ├── index.rst
...
1. Directorio restricciones/
   ...
   - Líneas: 9,621 → 10,071 (+450 líneas)
   - CNST-005 ampliado: +150 líneas (Permisos Temporales)
   - CNST-006 ampliado: +300 líneas (Patrones Recomendados)
   - Integración con RBAC v5.1.1

2. Comentario actualizado en restricciones/:
   - [DESCONGELADO] 10 CNST - v1.1.0 - 10,071 líneas
