...
describe('TransfersReportPage — estructura base', () => {
...
describe('TransfersReportPage — columnas del schema real', () => {
...
describe('TransfersReportPage — filtros reales (trimestre / segmento)', () => {
...
describe('TransfersReportPage — llamada al servicio', () => {
