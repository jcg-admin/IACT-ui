cat > /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte1.md << 'EOF'
...
EOF
echo "Parte 1 creada: $(wc -l < /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte1.md) líneas"
Output

Parte 1 creada: 110 líneas

bash

cat > /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte2.md << 'EOF'
---
...
EOF
echo "Parte 2 creada: $(wc -l < /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte2.md) líneas"
Output

Parte 2 creada: 77 líneas

bash

cat > /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte3.md << 'EOF'
---
...
```
EOF
echo "Parte 3 creada: $(wc -l < /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte3.md) líneas"
Output

Parte 3 creada: 154 líneas

cat > /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte4.md << 'EOF'
---
...
EOF
echo "Parte 4 creada: $(wc -l < /tmp/ANALISIS_FND_vs_MODELO_v2_0_4_parte4.md) líneas"
Output

Parte 4 creada: 175 líneas
