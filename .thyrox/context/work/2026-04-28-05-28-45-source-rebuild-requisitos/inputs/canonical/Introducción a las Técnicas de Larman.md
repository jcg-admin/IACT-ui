...
cat > /tmp/PARTE3_SECCION3_LARMAN_REGENERACION_COMPLETA_PARTE2.md << 'P3S3R2EOF'
...
cat > /tmp/PARTE3_SECCION3_LARMAN_PARTE4_SUBTEC22_23.md << 'P3S3P4EOF'
...
P3S3P4EOF
wc -l /tmp/PARTE3_SECCION3_LARMAN_PARTE4_SUBTEC22_23.md
Output

921 /tmp/PARTE3_SECCION3_LARMAN_PARTE4_SUBTEC22_23.md
...
cat > /tmp/PARTE3_SECCION3_LARMAN_PARTE5_FINAL.md << 'P3S3P5EOF'
...
P3S3P5EOF
wc -l /tmp/PARTE3_SECCION3_LARMAN_PARTE5_FINAL.md
Output

562 /tmp/PARTE3_SECCION3_LARMAN_PARTE5_FINAL.md
...
cat > /tmp/PARTE3_SECCIONES_4_A_12_COMPLETAS.md << 'P3S4A12EOF'
...
P3S4A12EOF
wc -l /tmp/PARTE3_SECCIONES_4_A_12_COMPLETAS.md
Output

1334 /tmp/PARTE3_SECCIONES_4_A_12_COMPLETAS.md
...
cat > /tmp/PARTE3_COMPLETA_ESTADO_FINAL.md << 'ESTADOFIN'
