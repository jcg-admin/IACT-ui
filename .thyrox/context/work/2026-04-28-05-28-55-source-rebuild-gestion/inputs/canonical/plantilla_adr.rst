...
reemplazada por ADR-XXX]

**Fecha:** YYYY-MM-DD

**Decisores:** [Lista de personas involucradas en la decisión]

**Contexto técnico:** [Backend \| Frontend \| Infrastructure \|
Full-stack]

Contexto y Problema
-------------------

Describe el contexto y el problema que estamos enfrentando. Esta sección
debe ser lo suficientemente clara para que alguien que no esté
familiarizado con el proyecto pueda entender el problema.
...
**Descripción:** [Explicación detallada de esta opción]
...
**Justificación:** Explica por qué se eligió esta opción sobre las
demás. Debe ser claro y convincente.
