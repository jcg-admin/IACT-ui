# 📜 RESTRICCIONES COMPLETAS - SISTEMA IACT
...
✅ OBLIGATORIO:
  ...
  - UC_037: Sistema de mensajería interno completo
...
- UC_036 a UC_040: Sistema de Alertas
...
## 🚀 7. RESTRICCIONES DE INFRAESTRUCTURA PROHIBIDO
...
- **SRS v2.0:** Requisitos funcionales completos
- **DRF Secure Code Checklist:** Seguridad Django/DRF
- **Análisis Antipatrones:** 10 antipatrones detectados
- **NIST RBAC:** Modelo de roles
- **OWASP Top 10:** Vulnerabilidades comunes
- **Django Security:** Best practices oficiales

---

**Documento vivo:** Este documento debe actualizarse cuando surjan nuevas restricciones o se modifiquen las existentes.
