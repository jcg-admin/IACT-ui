...
Este documento establece los estándares de código, convenciones de
nombrado, y mejores prácticas que deben seguirse en el desarrollo del
proyecto IACT.

Página padre
------------

-  `Arquitectura <README.md>`__
...
-  `Django Coding
   Style <https://docs.djangoproject.com/en/dev/internals/contributing/writing-code/coding-style/>`__
-  `Google Python Style
   Guide <https://google.github.io/styleguide/pyguide.html>`__
-  `Gobernanza del Proyecto <../gobernanza/README.md>`__
