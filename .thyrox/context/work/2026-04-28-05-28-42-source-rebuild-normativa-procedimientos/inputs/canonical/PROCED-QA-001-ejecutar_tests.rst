...
Proporcionar instrucciones paso a paso para ejecutar la suite completa
de tests del proyecto IACT, interpretar resultados y generar reportes de
coverage.

Alcance
-------

Este procedimiento cubre: - Ejecución de tests unitarios - Ejecución de
tests de integración - Generación de reportes de coverage -
Interpretación de resultados - Resolución de problemas comunes

NO cubre: - Escritura de nuevos tests - Configuración inicial del
entorno de testing - CI/CD pipelines
...
sin razón - Ejecutar tests skipped cuando sea posible:
...
**Causas comunes**: - Diferentes versiones de dependencias - Tests
dependientes de orden de ejecución - Tests que dependen de datos locales
