...
### CNST_002: Gestión de Sesiones en BD
...
### CNST_004: Actualización de Datos mediante ETL
...
### CNST_005: Seguridad Django REST Framework ⚠️ CRÍTICO
...
### CNST_006: Antipatrones de Arquitectura Prohibidos ⚠️ CRÍTICO
...
.. code-block:: python
   ...
   def user_deleted_handler(sender, instance, **kwargs):
       ...
       CNST_009: Auditoría obligatoria.
       CNST_005: Eliminación siempre lógica, nunca física.
       """
       UserActionLog.record(
               user=instance,
               action='USER_DELETED',
...
### CNST_007 a CNST_009: Sin Cambios Arquitectónicos

**CNST_007: Performance (1,061 → 1,062 líneas)**
- Metadatos
- Historial de cambios
- Referencias a funciones: `exporta_excel`, `exporta_csv`, `genera_reporte`

**CNST_008: Infraestructura (1,019 → 1,020 líneas)**
- Solo metadatos
- Sin referencias RBAC

**CNST_009: Logging (1,077 → 1,078 líneas)**
- Metadatos
- Historial de cambios
...
### CNST_010: Clasificación de Datos ⚠️ ALTA PRIORIDAD
...
|-----------|--------|--------|------------|----------|
| CNST_001 | 685 | 688 | +3 | +0.4% |
| CNST_002 | 840 | 841 | +1 | +0.1% |
| CNST_003 | 901 | 902 | +1 | +0.1% |
| CNST_004 | 920 | 921 | +1 | +0.1% |
| **CNST_005** | **994** | **1,339** | **+345** | **+34.7%** |
| **CNST_006** | **1,126** | **1,703** | **+577** | **+51.2%** |
| CNST_007 | 1,061 | 1,062 | +1 | +0.1% |
| CNST_008 | 1,019 | 1,020 | +1 | +0.1% |
| CNST_009 | 1,077 | 1,078 | +1 | +0.1% |
| CNST_010 | 998 | 1,002 | +4 | +0.4% |
...
4. Para CNST_005 y CNST_006: incluir secciones nuevas COMPLETAS
...
1. **CNST_001** (688 líneas) - Cambios metadatos + funciones
2. **CNST_002** (841 líneas) - Solo metadatos
3. **CNST_003** (902 líneas) - Solo metadatos
4. **CNST_004** (921 líneas) - Solo metadatos
5. **CNST_005** (1,339 líneas) ⚠️ - **CON ampliación Permisos Temporales** (+345 líneas)
6. **CNST_006** (1,703 líneas) ⚠️ - **CON ampliación Patrones Recomendados** (+577 líneas)
7. **CNST_007** (1,062 líneas) - Solo metadatos
8. **CNST_008** (1,020 líneas) - Solo metadatos
9. **CNST_009** (1,078 líneas) - Solo metadatos
10. **CNST_010** (1,002 líneas) - Metadatos + Matriz ACCESS_MATRIX
...
### Adaptador Legacy para CNST_005
...
- CNST_005: 1,339 líneas
- CNST_006: 1,703 líneas
- CNST_007: 1,062 líneas
- CNST_009: 1,078 líneas
...
# Para CNST_005 y CNST_006: verificar que existan las secciones nuevas
...
### Durante Generación
- [ ] CNST_001: Generado (688 líneas)
- [ ] CNST_002: Generado (841 líneas)
- [ ] CNST_003: Generado (902 líneas)
- [ ] CNST_004: Generado (921 líneas)
- [ ] CNST_005: Generado CON ampliación (1,339 líneas)
- [ ] CNST_006: Generado CON ampliación (1,703 líneas)
- [ ] CNST_007: Generado (1,062 líneas)
- [ ] CNST_008: Generado (1,020 líneas)
- [ ] CNST_009: Generado (1,078 líneas)
- [ ] CNST_010: Generado (1,002 líneas)
...
- [ ] Validar secciones nuevas (CNST_005, CNST_006)
...
- **2 ampliaciones** mayores:
  ...
  - CNST_006: +577 líneas (Patrones Recomendados)
...
Esperando confirmación para iniciar generación de CNST_001 (primer archivo).
