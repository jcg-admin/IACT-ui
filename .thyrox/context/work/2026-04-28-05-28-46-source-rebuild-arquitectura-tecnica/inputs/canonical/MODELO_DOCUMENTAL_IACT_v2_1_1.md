# 📘 MODELO DOCUMENTAL IACT v2.1.1

## Sistema de Documentación Gobernado y Trazable

**Versión:** 2.1.1  
**Fecha:** 2026-01-07  
**Estado:** ✅ OFICIAL — Versión con BR Completas y STD_006  
**Autor:** Equipo IACT  
**Clasificación:** Normativo  
**Base:** v2.1.0 + Completación BR (20/20) + STD_006 Versionado Semántico
...
| **v2.1.1** | **🆕 STD_006_Versionado_Semantico.rst añadido (340 líneas)** |
| **v2.1.1** | **🆕 BR_011 a BR_020 generadas - Catálogo BR completo (20/20)** |
| **v2.1.1** | **🆕 index.rst de reglas_negocio actualizado a v2.0.0** |
| **v2.1.1** | **🆕 Análisis de procedimientos pendientes (16 PROC identificados)** |
| **v2.1.1** | **🆕 Total STD: 6 (antes 5)** |
...
```
5 DOMINIOS + 21 SUBDOMINIOS + 6 SUBCARPETAS ORGANIZATIVAS + 49 UC + 55 FR (en progreso) + 20 BR + 6 STD
```
...
# 6. BUSINESS RULES (BR) — 20 Reglas 🆕 COMPLETAS v2.1.1
...
| **STD_006** | **Versionado Semántico** | **340** | **🆕 v2.1.1** |

## 10.2 STD_006 Versionado Semántico (Nuevo)
...
│   │
│   ├── reglas_negocio/                          # 🆕 [CONGELADO] 20 BR COMPLETAS
...
│   │
│   ├── procedimientos/                          # [CONGELADO] 3 PROC
│   │   ├── index.rst
...
## 12.1 Estado Actual del Proyecto (v2.1.1)

| Métrica | v2.1.0 | v2.1.1 | Cambio |
|---------|--------|--------|--------|
| BReq documentados | 8 | 8 | = |
| BR documentadas | 20 | **20** | ✅ Completas |
| UC generados | 49 | 49 | = |
...
# 13. PROCEDIMIENTOS PENDIENTES (Identificados v2.1.1)

## 13.1 Gap de Procedimientos
...
## 13.2 Procedimientos Críticos para Fase Actual

| Prioridad | PROC | Descripción |
|-----------|------|-------------|
| 🔴 P0 | PROC_006 | Generación de FR |
| 🔴 P0 | PROC_014 | Derivación UC → FR |
| 🟠 P1 | PROC_020 | Actualizar Modelo Documental |
| 🟠 P1 | PROC_017 | Aplicar Versionado Semántico |
...
|---------|-----------|-----------|
| MODELO_DOCUMENTAL_IACT_v2_1_1.md | Este documento | /tmp/ |
| MODELO_DOCUMENTAL_IACT_v2_1_0.md | Versión anterior | /uploads/ |
| MODELO_RBAC_IACT_v5_1_1.md | Modelo de permisos | /uploads/ |
| DEFINICIONES_OFICIALES_v2_0_0.md | Definiciones base | /uploads/ |
| STD_006_Versionado_Semantico.rst | Nuevo estándar | normativa/estandares/ |
| BR_011 a BR_020 | Nuevas BR | requisitos/reglas_negocio/ |
| ANALISIS_PROCEDIMIENTOS_PENDIENTES.md | Gap de PROC | /tmp/ |
...
*Cambios: +1 STD, +10 BR, análisis de procedimientos*
