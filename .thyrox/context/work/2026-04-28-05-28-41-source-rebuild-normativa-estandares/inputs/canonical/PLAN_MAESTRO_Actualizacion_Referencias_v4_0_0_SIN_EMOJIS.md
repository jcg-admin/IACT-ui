...
**Problema:** Aproximadamente **97 referencias obsoletas** distribuidas en 20 archivos de base_cognitiva/ y 7 módulos UC pendientes de verificación.
...
|------------|----------|-------------|--------|
| **access/index.rst** | 1 | ~15 | [READY] SOLUCIÓN LISTA |
| **_fundamentos_conceptuales/** | 7 | ~20 | [PENDING] |
| **metamodelos/** | 3 | ~16 | [PENDING] |
| **taxonomias/** | 3 | ~25 | [PENDING] |
| **Otros 7 módulos UC** | 7 | ~21 | [NOT_VERIFIED] |
| **TOTAL** | **21** | **~97** | - |

### 1.4 Esfuerzo Estimado

- **Análisis y mapeo:** 2-3 horas [DONE] COMPLETADO
...
#### [VERIFIED] Ya Verificados
1. access/ (UC individuales) - [OK] sin cambios
2. access/index.rst - [READY] SOLUCIÓN LISTA (index_access_v4.rst)
3. _metadata/ - [OK] sin cambios
4. _ontologia_sbvr/ - [OK] sin cambios

#### [PENDING] Pendientes de Actualizar
...
#### [NOT_VERIFIED] Pendientes de Verificar
8. auth/index.rst
9. users/index.rst
...
- [OK] Archivos UC individuales (ya están en v4.0.0)
- [OK] _metadata/ (sin referencias UC)
- [OK] _ontologia_sbvr/ (referencias genéricas correctas)
- [EXCLUDED] Código fuente Python (fuera de alcance documental)
- [EXCLUDED] Bases de datos (fuera de alcance documental)
...
**Estado:** [NOT_VERIFIED] NO VERIFICADOS  
...
|--------|---------|--------------|--------|
| auth/ | index.rst | UC_AUTH_01-05 | [NOT_VERIFIED] |
| users/ | index.rst | UC_USR_01-04 | [NOT_VERIFIED] |
| pipeline/ | index.rst | UC_PIP_01-04 | [NOT_VERIFIED] |
| reports/ | index.rst | UC_RPT_01-14 | [NOT_VERIFIED] |
| alerts/ | index.rst | UC_ALR_01-05 | [NOT_VERIFIED] |
| audit/ | index.rst | UC_AUD_01-04 | [NOT_VERIFIED] |
| logs/ | index.rst | UC_LOG_01-04 | [NOT_VERIFIED] |
...
|------------|----------|-------------|--------|------------|
| access/index.rst | 1 | 15 | 0h [DONE] | N/A |
...
|------|-----------|--------|--------|
| 0 | Análisis y mapeo | 2-3h | [DONE] |
| 1 | Verificar 7 módulos UC | 1h | [TODO] |
| 2 | Actualizar 7 módulos UC | 3-4h | [TODO] |
| 3 | Actualizar fundamentos | 2-3h | [TODO] |
| 4 | Actualizar metamodelos | 1-2h | [TODO] |
| 5 | Actualizar taxonomías | 2-3h | [TODO] |
| 6 | Validación y testing | 2-3h | [TODO] |
| | **TOTAL** | **13-19h** | - |
...
### FASE 0: Preparación [DONE] COMPLETADO
...
- [x] Creación de documento STD_01 (sin emojis)
...
3. Generar versiones actualizadas (index_[modulo]_v4.rst)
...
|-----|-----------------|--------|
| **Arquitecto de Documentación** | Aprobar plan maestro | [PENDING] |
| **BA Lead** | Validar mapeo UC | [PENDING] |
| **Equipo Técnico** | Revisar cambios | [PENDING] |
...
**Fecha:** 2026-01-07  
**Estado:** EN ANÁLISIS - PENDIENTE APROBACIÓN  
**Nota:** Este documento cumple con STD_01 (Sin emojis ni iconos Unicode)
